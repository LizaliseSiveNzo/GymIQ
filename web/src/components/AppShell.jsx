...
const NAV = {
  ...
  coach:  [['Dashboard','▚','/coach'],['Squad','👥','/coach/squad'],['Schedule','📅','/coach/schedule'],['Matches','⚽','/coach/match'],['Announcements','📣','/coach/announcements'],['Training','➕','/coach/training'],['Leaderboard','🏆','/leaderboard']],
